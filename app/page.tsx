        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
          <div className="grid lg:grid-cols-5 gap-12 items-center">
            ...
            <div className="lg:col-span-2 hidden lg:block">
              <div className="aspect-square rounded-2xl overflow-hidden border border-slate-700 relative">
                <Image
                  src="/hero-image.jpg"
                  alt="3D Printer creating a prototype at 3D Labs OKC"
                  fill
                  className="object-cover"
                  priority
                />
                {/* Fallback gradient if image doesn't load */}
                <div className="absolute inset-0 bg-gradient-to-br from-accent/20 to-secondary-accent/20 -z-10" />
              </div>
            </div>
          </div>
        </div>
